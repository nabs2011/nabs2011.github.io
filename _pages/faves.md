...
Naval's [tweet-storm](https://twitter.com/naval/status/1002103360646823936) that covers his core principles on work and life. I've found this to be one of the most impactful things I've ever read and I often find myself thinking about the ideas in here. Especially the thoughts on leverage and zero-sum thinking. I treat this tweet-storm as a reference guide I come back to once every few months to help rebalance my thinking. Naval's also expanded this tweet-storm into a podcast you can find [here](https://nav.al/)   


#### Thinking about the world's geography

This [short-form essay](https://unchartedterritories.tomaspueyo.com/p/geography-is-the-chessboard-of-history) by Tomas Pueyo blew my mind. It's a very clever look into the differece between the history and geography we're taught at school. History tends to be written by the victors which means we end up with a warped representation of it, which means when we normally only tend to learn one side of it. The first line in Tomas' essay captures this perfectly - _"We think we’re taught History. But we’re really taught Propaganda"_.   
...
This timeless HBR article is from back in May 2011 and it covers the [power of small wins](https://hbr.org/2011/05/the-power-of-small-wins). We're all working on goals which we can't achieve in a day, this article breaks down the importance of thinking about small wins and how, if done properly, celebrating small wins can help you feel accomplished and build the motivation to keep on track for those bigger goals.  


#### Rest and recovery

This is especially relevant at the moment as we face the Covid-19 pandemic but I will always come back to the ideas from this article when I need to rest and reset. In [this article](https://thesector.com.au/2021/01/06/exhausted-by-2020-here-are-5-steps-to-recover-and-feel-more-rested-throughout-2021/) Peter Heslin a Professor at UNSW breaks down the difference between a recovery activity and a recovery experience. It's a short read but it really home for me. It really highlighted the importance of resting properly in very achieveable steps.
...
![image-center](/images/faves/waitbutwhyreligion.png){: width="250" }
